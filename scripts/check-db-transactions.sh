...
SOURCE="$ROOT_DIR/server/src/db_transactions.vais"
OUT_DIR="${MONITOR_OUT_DIR:-${TMPDIR:-/tmp}/vais-monitor-db-transactions}"
IR_FILE="$OUT_DIR/db_transactions.ll"
BIN_FILE="$OUT_DIR/db_transactions"
LOG_FILE="$OUT_DIR/db_transactions.vaisc.log"
CLANG_LOG="$OUT_DIR/db_transactions.clang.log"
DB_FILE="/tmp/vais-monitor-db-transactions.sqlite"
...
echo "DB transactions fixture passed: $BIN_FILE"
