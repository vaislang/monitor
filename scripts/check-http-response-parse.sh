...
SOURCE="$ROOT_DIR/server/src/http_response_parse.vais"
OUT_DIR="${MONITOR_OUT_DIR:-${TMPDIR:-/tmp}/vais-monitor-http-response-parse}"
IR_FILE="$OUT_DIR/http_response_parse.ll"
BIN_FILE="$OUT_DIR/http_response_parse"
LOG_FILE="$OUT_DIR/http_response_parse.vaisc.log"
CLANG_LOG="$OUT_DIR/http_response_parse.clang.log"
...
test -x "$BIN_FILE"
"$BIN_FILE"
echo "HTTP response parse fixture passed: $BIN_FILE"
