...
SOURCE="$ROOT_DIR/server/src/http_response.vais"
OUT_DIR="${MONITOR_OUT_DIR:-${TMPDIR:-/tmp}/vais-monitor-http-response}"
IR_FILE="$OUT_DIR/http_response.ll"
BIN_FILE="$OUT_DIR/http_response"
LOG_FILE="$OUT_DIR/http_response.vaisc.log"
CLANG_LOG="$OUT_DIR/http_response.clang.log"
...
test -x "$BIN_FILE"
"$BIN_FILE"
echo "HTTP response fixture passed: $BIN_FILE"
