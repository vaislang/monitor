...
SOURCE="$ROOT_DIR/server/src/db_persistence.vais"
OUT_DIR="${MONITOR_OUT_DIR:-${TMPDIR:-/tmp}/vais-monitor-db-persistence}"
IR_FILE="$OUT_DIR/db_persistence.ll"
BIN_FILE="$OUT_DIR/db_persistence"
LOG_FILE="$OUT_DIR/db_persistence.vaisc.log"
CLANG_LOG="$OUT_DIR/db_persistence.clang.log"
DB_FILE="/tmp/vais-monitor-db-persistence.sqlite"
...
echo "DB persistence fixture passed: $BIN_FILE"
