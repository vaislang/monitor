...
SOURCE="$ROOT_DIR/server/src/http_adapter.vais"
OUT_DIR="${MONITOR_OUT_DIR:-${TMPDIR:-/tmp}/vais-monitor-http-adapter}"
IR_FILE="$OUT_DIR/http_adapter.ll"
BIN_FILE="$OUT_DIR/http_adapter"
LOG_FILE="$OUT_DIR/http_adapter.vaisc.log"
CLANG_LOG="$OUT_DIR/http_adapter.clang.log"
...
test -x "$BIN_FILE"
"$BIN_FILE"
echo "HTTP adapter fixture passed: $BIN_FILE"
