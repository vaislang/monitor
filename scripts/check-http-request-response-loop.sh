...
SOURCE="$ROOT_DIR/server/src/http_request_response_loop.vais"
OUT_DIR="${MONITOR_OUT_DIR:-${TMPDIR:-/tmp}/vais-monitor-http-request-response-loop}"
IR_FILE="$OUT_DIR/http_request_response_loop.ll"
BIN_FILE="$OUT_DIR/http_request_response_loop"
LOG_FILE="$OUT_DIR/http_request_response_loop.vaisc.log"
CLANG_LOG="$OUT_DIR/http_request_response_loop.clang.log"
...
test -x "$BIN_FILE"
"$BIN_FILE"
echo "HTTP request-response loop fixture passed: $BIN_FILE"
